...
export function Calendar(props: CalendarProps) {
  ...
  const [selectedItem, setSelectedItem] = useState<DateSelectArg | null>(null);
  ...
  useEffect(() => {
    const createEvent = async () => {
      if (onSaveNewEvent && selectedItem) {
    ...
    createEvent();
  }, [onSaveNewEvent, selectedItem, newEvent.companieSelected.id, newEvent.eventName, router]);
